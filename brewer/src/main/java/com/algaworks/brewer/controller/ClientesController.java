...
public class ClientesController {
	...
	@Autowired
	private CadastroClienteService cadastroClienteService; // injetar para Salvar.
	...
	// Controlller para pesquisa rapida de clientes.
	...
	// Tratamento de erro - pesquisa rapida.
