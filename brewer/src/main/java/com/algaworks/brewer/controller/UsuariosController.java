...
public class UsuariosController {
	...
	public ModelAndView pesquisar(UsuarioFilter usuarioFilter,
		...
		// Chamando a classe que organiza o filtro da página - filtro
		PageWrapper<Usuario> paginaWrapper = new PageWrapper<>(usuarios.filtrar(usuarioFilter, 
				pageable), httpServletRequest);
		mv.addObject("pagina", paginaWrapper);
		return mv;
	}
	
	// Metodo PUT - Atulaizar status.
	@PutMapping("/status")
