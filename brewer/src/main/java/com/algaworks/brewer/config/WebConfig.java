...
public class WebConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware{
	...
	@Bean // Fica disponivel no contexto do spring.
	// Encontrar as View.
	...
	@Override
	// Adicionar recursos que não tem o controller.
...
//	@Bean
//	// Tratar o valor para o formato brasileiro.
//	public LocaleResolver localeResolver() {
//		return new FixedLocaleResolver(new Locale("pt", "BR"));
//	}
	
	// Salvar cidades no cache.
	@Bean
